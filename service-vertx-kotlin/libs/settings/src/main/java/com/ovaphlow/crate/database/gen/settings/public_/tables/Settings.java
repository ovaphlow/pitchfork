 ...
 */
package com.ovaphlow.crate.database.gen.settings.public_.tables;


import com.ovaphlow.crate.database.gen.settings.public_.Indexes;
import com.ovaphlow.crate.database.gen.settings.public_.Keys;
import com.ovaphlow.crate.database.gen.settings.public_.Public;
import com.ovaphlow.crate.database.gen.settings.public_.tables.records.SettingsRecord;
...
public class Settings extends TableImpl<SettingsRecord> {
     ...
     */
    public final TableField<SettingsRecord, String> ID = createField(DSL.name("id"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>public.settings.category</code>.
     */
    public final TableField<SettingsRecord, String> CATEGORY = createField(DSL.name("category"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.settings.code</code>.
     */
    public final TableField<SettingsRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.settings.root_code</code>.
     */
    public final TableField<SettingsRecord, String> ROOT_CODE = createField(DSL.name("root_code"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field(DSL.raw("''::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.settings.parent_code</code>.
     */
    public final TableField<SettingsRecord, String> PARENT_CODE = createField(DSL.name("parent_code"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field(DSL.raw("''::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.settings.payload</code>.
     */
