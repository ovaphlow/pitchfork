...
class MedicalOrderIntegrationTest {
    ...
    private fun setupFixtures() {
        DriverManager.getConnection(jdbcUrl(), user, password).use { conn ->
            ...
            stmt.execute("INSERT INTO public.materials (id, code, name, category, package_unit, status) VALUES ('${fixtureId("mat-bait")}', 'MO-MAT-BAIT', '诱饵材料', '耗材', '包', 'ACTIVE') ON CONFLICT (id) DO NOTHING")
