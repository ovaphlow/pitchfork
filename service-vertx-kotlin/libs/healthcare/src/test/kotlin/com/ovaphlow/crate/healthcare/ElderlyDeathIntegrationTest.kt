...
class ElderlyDeathIntegrationTest {
    ...
    private fun setupFixtures() {
        DriverManager.getConnection(jdbcUrl(), user, password).use { conn ->
            ...
            // 库存诱饵
            stmt.execute("INSERT INTO public.materials (id, code, name, category, base_unit, quantity_scale, package_unit, package_size, status) VALUES ('${fixtureId("mat-bait")}', 'ED-MAT-BAIT', '诱饵材料', '耗材', '个', 0, '包', 1, 'ACTIVE') ON CONFLICT (id) DO NOTHING")
