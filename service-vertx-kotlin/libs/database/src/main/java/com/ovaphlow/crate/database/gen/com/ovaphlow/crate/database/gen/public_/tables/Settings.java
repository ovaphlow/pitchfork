...
public class Settings extends TableImpl<SettingsRecord> {
     ...
     */
    public final TableField<SettingsRecord, String> ROOT_CODE = createField(DSL.name("root_code"), SQLDataType.VARCHAR.defaultValue(DSL.field(DSL.raw("''::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.settings.parent_code</code>.
     */
    public final TableField<SettingsRecord, String> PARENT_CODE = createField(DSL.name("parent_code"), SQLDataType.VARCHAR.defaultValue(DSL.field(DSL.raw("''::character varying"), SQLDataType.VARCHAR)), this, "");
